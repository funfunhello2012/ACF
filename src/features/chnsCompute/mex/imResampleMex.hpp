...
#ifndef SRC_FEATURES_CHNSCOMPUTE_MEX_IMRESAMPLEMEX_HPP_
#define SRC_FEATURES_CHNSCOMPUTE_MEX_IMRESAMPLEMEX_HPP_
...
#endif /* SRC_FEATURES_CHNSCOMPUTE_MEX_IMPADMEX_HPP_ */
