...
#ifndef SRC_FEATURES_CHNSCOMPUTE_MEX_RGBCONVERTMEX_HPP_
#define SRC_FEATURES_CHNSCOMPUTE_MEX_RGBCONVERTMEX_HPP_
...
#endif /* SRC_FEATURES_CHNSCOMPUTE_MEX_RGBCONVERTMEX_HPP_ */
